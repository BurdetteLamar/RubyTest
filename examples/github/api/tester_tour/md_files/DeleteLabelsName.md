...
<delete_labels_name_test>
  ...
  <test_method name='delete_labels_name_test' timestamp='2017-12-10-Sun-13.57.16.036'>
    <section duration_seconds='3.160' name='Test'>
      <section name='Test DeleteLabelsName'>
        <section name='Create the label to be deleted'>
          <ApiClient method='GET' url='https://api.github.com/repos/BurdetteLamar/CrashDummy/labels/test%20label'>
            <execution duration_seconds='1.750' timestamp='2017-12-10-Sun-13.57.16.036'/>
          </ApiClient>
          <ApiClient method='POST' url='https://api.github.com/repos/BurdetteLamar/CrashDummy/labels'>
            ...
            <execution duration_seconds='0.360' timestamp='2017-12-10-Sun-13.57.17.786'/>
          </ApiClient>
        </section>
        <section name='Test deleting the created label'>
          <section name='delete_label' timestamp='2017-12-10-Sun-13.57.18.146'>
            <ApiClient method='DELETE' url='https://api.github.com/repos/BurdetteLamar/CrashDummy/labels/test%20label'>
              <execution duration_seconds='0.350' timestamp='2017-12-10-Sun-13.57.18.146'/>
            </ApiClient>
            <section name='Evaluation'>
              ...
              <section name='Label deleted'>
                <ApiClient method='GET' url='https://api.github.com/repos/BurdetteLamar/CrashDummy/labels/test%20label'>
                  <execution duration_seconds='0.340' timestamp='2017-12-10-Sun-13.57.18.496'/>
                </ApiClient>
          ...
          <section name='Clean up'>
            <ApiClient method='GET' url='https://api.github.com/repos/BurdetteLamar/CrashDummy/labels/test%20label'>
              <execution duration_seconds='0.360' timestamp='2017-12-10-Sun-13.57.18.836'/>
            </ApiClient>
          </section>
        </section>
      </section>
