...
<first_test>
  ...
  <test_method name='first_test' timestamp='2017-12-10-Sun-13.56.09.485'>
    <section name='Test'>
      <section name='Create'>
        <ApiClient method='GET' url='https://api.github.com/repos/BurdetteLamar/CrashDummy/labels/test%20label'>
          <execution duration_seconds='2.020' timestamp='2017-12-10-Sun-13.56.09.525'/>
        </ApiClient>
        <ApiClient method='POST' url='https://api.github.com/repos/BurdetteLamar/CrashDummy/labels'>
          ...
          <execution duration_seconds='0.330' timestamp='2017-12-10-Sun-13.56.11.575'/>
        </ApiClient>
        <section class='Label' method='verdict_equal?' name='create_return_correct'>
          ...
          <ApiClient method='GET' url='https://api.github.com/repos/BurdetteLamar/CrashDummy/labels/test%20label'>
            <execution duration_seconds='0.360' timestamp='2017-12-10-Sun-13.56.11.925'/>
          </ApiClient>
          <section class='Label' method='verdict_equal?' name='created_correctly'>
            <verdict id='created_correctly:id' method='verdict_assert_equal?' outcome='passed' volatile='false'>
              <exp_value>774950518</exp_value>
              <act_value>774950518</act_value>
            </verdict>
          ...
          <section name='Read'>
            <ApiClient method='GET' url='https://api.github.com/repos/BurdetteLamar/CrashDummy/labels/test%20label'>
              <execution duration_seconds='0.360' timestamp='2017-12-10-Sun-13.56.12.295'/>
            </ApiClient>
            ...
            <section duration_seconds='4.660' name='Update'>
              <ApiClient method='PATCH' url='https://api.github.com/repos/BurdetteLamar/CrashDummy/labels/test%20label'>
                <parameters color='ffffff'/>
                <execution duration_seconds='0.340' timestamp='2017-12-10-Sun-13.56.12.695'/>
              </ApiClient>
              <section name='Label to update'>
                <data field='id' value='774950518'/>
              ...
              <section class='Label' method='verdict_equal?' name='update_return_correct'>
                ...
                <ApiClient method='GET' url='https://api.github.com/repos/BurdetteLamar/CrashDummy/labels/test%20label'>
                  <execution duration_seconds='0.330' timestamp='2017-12-10-Sun-13.56.13.065'/>
                </ApiClient>
                ...
                <section name='Delete'>
                  <ApiClient method='DELETE' url='https://api.github.com/repos/BurdetteLamar/CrashDummy/labels/test%20label'>
                    <execution duration_seconds='0.340' timestamp='2017-12-10-Sun-13.56.13.445'/>
                  </ApiClient>
                  <verdict id='delete_return_correct' method='verdict_assert_nil?' outcome='passed' volatile='false'>
                    <act_value>nil</act_value>
                  </verdict>
                  <ApiClient method='GET' url='https://api.github.com/repos/BurdetteLamar/CrashDummy/labels/test%20label'>
                    <execution duration_seconds='0.350' timestamp='2017-12-10-Sun-13.56.13.795'/>
                  </ApiClient>
