...
<crud_test>
  ...
  <test_method duration_seconds='5.150' name='crud_test' timestamp='2018-01-15-Mon-12.38.14.214'>
    <section name='Test'>
      <section name='Create'>
        ...
        <section name='Delete if exists, to avoid collision'>
          <ApiClient method='GET' url='https://api.github.com/repos/BurdetteLamar/CrashDummy/labels/test%20label'>
            <execution duration_seconds='3.720' timestamp='2018-01-15-Mon-12.38.14.214'/>
          </ApiClient>
        ...
        <ApiClient method='POST' url='https://api.github.com/repos/BurdetteLamar/CrashDummy/labels'>
          ...
          <execution duration_seconds='0.360' timestamp='2018-01-15-Mon-12.38.17.934'/>
        </ApiClient>
        <section name='Label created'>
          <data field='id' value='805552852'/>
      ...
      <section name='Read'>
        ...
        <ApiClient method='GET' url='https://api.github.com/repos/BurdetteLamar/CrashDummy/labels/test%20label'>
          <execution duration_seconds='0.330' timestamp='2018-01-15-Mon-12.38.18.294'/>
        </ApiClient>
      ...
      <section name='Update'>
        ...
        <ApiClient method='PATCH' url='https://api.github.com/repos/BurdetteLamar/CrashDummy/labels/test%20label'>
          ...
          <execution duration_seconds='0.350' timestamp='2018-01-15-Mon-12.38.18.634'/>
        </ApiClient>
      ...
      <section name='Delete'>
        <ApiClient method='DELETE' url='https://api.github.com/repos/BurdetteLamar/CrashDummy/labels/not%20test%20label'>
          <execution duration_seconds='0.380' timestamp='2018-01-15-Mon-12.38.18.984'/>
        </ApiClient>
      </section>
    </section>
  </test_method>
