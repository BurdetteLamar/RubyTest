...
<sections_test>
  ...
  <test_method duration_seconds='6.030' name='sections_test' timestamp='2018-01-15-Mon-12.37.25.764'>
    <section name='Test'>
      ...
      <section name='Section with timestamp' timestamp='2018-01-15-Mon-12.37.25.764'>
        <comment>Some test code can go here</comment>
      </section>
      <section duration_seconds='1.010' name='Section with timestamp'>
        <comment>Some test code can go here</comment>
      </section>
      <section duration_seconds='2.010' name='Section with timestamp and duration' timestamp='2018-01-15-Mon-12.37.26.774'>
        <comment>Some test code can go here</comment>
      </section>
      <section duration_seconds='3.010' name='Order does not matter' timestamp='2018-01-15-Mon-12.37.28.784'>
        <comment>Some test code can go here</comment>
      </section>
    </section>
  </test_method>
