...
<sections_test>
  ...
  <test_method duration_seconds='6.053' name='sections_test' timestamp='2018-01-15-Mon-13.14.39.911'>
    <section name='Test'>
      ...
      <section name='Section with timestamp' timestamp='2018-01-15-Mon-13.14.39.927'>
        <comment>Some test code can go here</comment>
      </section>
      <section duration_seconds='1.014' name='Section with timestamp'>
        <comment>Some test code can go here</comment>
      </section>
      <section duration_seconds='2.012' name='Section with timestamp and duration' timestamp='2018-01-15-Mon-13.14.40.941'>
        <comment>Some test code can go here</comment>
      </section>
      <section duration_seconds='3.011' name='Order does not matter' timestamp='2018-01-15-Mon-13.14.42.953'>
        <comment>Some test code can go here</comment>
      </section>
    </section>
  </test_method>
