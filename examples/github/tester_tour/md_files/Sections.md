...
<sections_test>
  ...
  <test_method duration_seconds='6.037' name='sections_test' timestamp='2017-12-18-Mon-11.32.36.634'>
    <section name='Test'>
      ...
      <section name='Section with timestamp' timestamp='2017-12-18-Mon-11.32.36.634'>
        <comment>Some test code can go here</comment>
      </section>
      <section duration_seconds='1.014' name='Section with timestamp'>
        <comment>Some test code can go here</comment>
      </section>
      <section duration_seconds='2.012' name='Section with timestamp and duration' timestamp='2017-12-18-Mon-11.32.37.648'>
        <comment>Some test code can go here</comment>
      </section>
      <section duration_seconds='3.011' name='Order does not matter' timestamp='2017-12-18-Mon-11.32.39.661'>
        <comment>Some test code can go here</comment>
      </section>
    </section>
  </test_method>
