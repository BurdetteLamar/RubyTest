...
<sections_test>
  ...
  <test_method duration_seconds='6.020' name='sections_test' timestamp='2017-12-10-Sun-14.15.32.461'>
    <section name='Test'>
      ...
      <section name='Section with timestamp' timestamp='2017-12-10-Sun-14.15.32.471'>
        <comment>Some test code can go here</comment>
      </section>
      <section duration_seconds='1.000' name='Section with timestamp'>
        <comment>Some test code can go here</comment>
      </section>
      <section duration_seconds='2.010' name='Section with timestamp and duration' timestamp='2017-12-10-Sun-14.15.33.471'>
        <comment>Some test code can go here</comment>
      </section>
      <section duration_seconds='3.000' name='Order does not matter' timestamp='2017-12-10-Sun-14.15.35.481'>
        <comment>Some test code can go here</comment>
      </section>
    </section>
  </test_method>
