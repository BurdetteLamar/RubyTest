...
<crud_test>
  ...
  <test_method duration_seconds='4.793' name='crud_test' timestamp='2017-12-02-Sat-12.54.23.117'>
    <section name='With GithubClient'>
      <section name='Create'>
        ...
        <section name='Delete if exists, to avoid collision'>
          <GithubClient method='GET' url='https://api.github.com/repos/BurdetteLamar/RubyTest/labels/test%20label'>
            <execution duration_seconds='3.403' timestamp='2017-12-02-Sat-12.54.23.117'/>
          </GithubClient>
        ...
        <GithubClient method='POST' url='https://api.github.com/repos/BurdetteLamar/RubyTest/labels'>
          ...
          <execution duration_seconds='0.344' timestamp='2017-12-02-Sat-12.54.26.520'/>
        </GithubClient>
        <section name='Label created'>
          <data field='id' value='767616249'/>
      ...
      <section name='Read'>
        ...
        <GithubClient method='GET' url='https://api.github.com/repos/BurdetteLamar/RubyTest/labels/test%20label'>
          <execution duration_seconds='0.328' timestamp='2017-12-02-Sat-12.54.26.864'/>
        </GithubClient>
      ...
      <section name='Update'>
        ...
        <GithubClient method='PATCH' url='https://api.github.com/repos/BurdetteLamar/RubyTest/labels/test%20label'>
          ...
          <execution duration_seconds='0.359' timestamp='2017-12-02-Sat-12.54.27.192'/>
        </GithubClient>
      ...
      <section name='Delete'>
        <GithubClient method='DELETE' url='https://api.github.com/repos/BurdetteLamar/RubyTest/labels/test%20label'>
          <execution duration_seconds='0.359' timestamp='2017-12-02-Sat-12.54.27.551'/>
        </GithubClient>
      </section>
    </section>
  </test_method>
