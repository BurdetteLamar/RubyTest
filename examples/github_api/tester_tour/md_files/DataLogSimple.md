...
<data_log_simple_test>
  ...
  <test_method duration_seconds='1.954' name='data_log_simple_test' timestamp='2017-10-12-Thu-15.18.55.017'>
      ...
      <section name='Fetch and log an instance of IssueLabel'>
        <section name='Fetch an issue label'>
          <GithubClient method='GET' url='https://api.github.com/repos/BurdetteLamar/CrashDummy/issues/1/labels'>
            <execution duration_seconds='1.690' timestamp='2017-10-12-Thu-15.18.55.021'/>
          </GithubClient>
          <GithubClient method='GET' url='https://api.github.com/repos/BurdetteLamar/CrashDummy/issues/1/labels'>
            <execution duration_seconds='0.259' timestamp='2017-10-12-Thu-15.18.56.712'/>
          </GithubClient>
        </section>
