...
<nested_data_log_test>
  ...
  <test_method duration_seconds='3.266' name='nested_data_log_test' timestamp='2017-12-07-Thu-10.49.22.059'>
      ...
      <section name='Fetch and log a rate limit'>
        <section name='Fetch rate limit'>
          <GithubClient method='GET' url='https://api.github.com/rate_limit'>
            <execution duration_seconds='3.266' timestamp='2017-12-07-Thu-10.49.22.059'/>
          </GithubClient>
        </section>
