...
<nested_data_log_test>
  ...
  <test_method duration_seconds='3.563' name='nested_data_log_test' timestamp='2017-12-03-Sun-10.03.16.391'>
      ...
      <section name='Fetch and log a rate limit'>
        <section name='Fetch rate limit'>
          <GithubClient method='GET' url='https://api.github.com/rate_limit'>
            <execution duration_seconds='3.453' timestamp='2017-12-03-Sun-10.03.16.501'/>
          </GithubClient>
        </section>
