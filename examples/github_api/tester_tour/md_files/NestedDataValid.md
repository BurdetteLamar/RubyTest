...
<nested_data_valid_test>
  ...
  <test_method duration_seconds='3.360' name='nested_data_valid_test' timestamp='2017-11-18-Sat-12.40.27.570'>
    <section name='With GithubClient'>
      <GithubClient method='GET' url='https://api.github.com/rate_limit'>
        <execution duration_seconds='3.297' timestamp='2017-11-18-Sat-12.40.27.570'/>
      </GithubClient>
      <section name='This is valid'>
        <section name='RateLimit verdict_valid? rate_limit_valid'>
          <section name='RateLimit::Resources verdict_valid? [[:rate_limit_valid, :resources], :resources]'>
            <section name='RateLimit::Core_ verdict_valid? [[[[:rate_limit_valid, :resources], :resources], :core], :core]'>
              ...
              <section name='verdict_assert_integer_positive?'>
                ...
                <verdict id='rate_limit_valid:resources:resources:core:core:reset:positive' method='verdict_assert_operator?' outcome='passed' volatile='false'>
                  <object_1>1511031606</object_1>
                  <operator>:&gt;</operator>
                  <object_2>0</object_2>
                </verdict>
              </section>
            </section>
            <section name='RateLimit::Search verdict_valid? [[[[:rate_limit_valid, :resources], :resources], :search], :search]'>
              <section name='verdict_assert_integer_positive?'>
              ...
              <section name='verdict_assert_integer_positive?'>
                <verdict id='rate_limit_valid:resources:resources:search:search:reset:integer' method='verdict_assert_kind_of?' outcome='passed' volatile='false'>
                  <exp_value>Integer</exp_value>
                  <act_value>1511030490</act_value>
                </verdict>
                <verdict id='rate_limit_valid:resources:resources:search:search:reset:positive' method='verdict_assert_operator?' outcome='passed' volatile='false'>
                  <object_1>1511030490</object_1>
                  <operator>:&gt;</operator>
                  <object_2>0</object_2>
                </verdict>
              </section>
            </section>
            <section name='RateLimit::Graphql verdict_valid? [[[[:rate_limit_valid, :resources], :resources], :graphql], :graphql]'>
              <section name='verdict_assert_integer_positive?'>
              ...
              <section name='verdict_assert_integer_positive?'>
                <verdict id='rate_limit_valid:resources:resources:graphql:graphql:reset:integer' method='verdict_assert_kind_of?' outcome='passed' volatile='false'>
                  <exp_value>Integer</exp_value>
                  <act_value>1511034030</act_value>
                </verdict>
          ...
          <section name='RateLimit::Rate verdict_valid? [[:rate_limit_valid, :rate], :rate]'>
            <section name='verdict_assert_integer_positive?'>
      ...
      <section name='This is not valid'>
        <section name='RateLimit verdict_valid? rate_limit_not_valid'>
          <section name='RateLimit::Resources verdict_valid? [[:rate_limit_not_valid, :resources], :resources]'>
            <section name='RateLimit::Core_ verdict_valid? [[[[:rate_limit_not_valid, :resources], :resources], :core], :core]'>
              <section name='verdict_assert_integer_positive?'>
...
C:/Users/Burdette/Documents/GitHub/RubyTest/examples/github_api/tester_tour/tests/nested_data_valid_test.rb:8:in `test_nested_data_valid']]>
            ...
            <section name='RateLimit::Search verdict_valid? [[[[:rate_limit_not_valid, :resources], :resources], :search], :search]'>
              <section name='verdict_assert_integer_positive?'>
            ...
            <section name='RateLimit::Graphql verdict_valid? [[[[:rate_limit_not_valid, :resources], :resources], :graphql], :graphql]'>
              <section name='verdict_assert_integer_positive?'>
          ...
          <section name='RateLimit::Rate verdict_valid? [[:rate_limit_not_valid, :rate], :rate]'>
            <section name='verdict_assert_integer_positive?'>
