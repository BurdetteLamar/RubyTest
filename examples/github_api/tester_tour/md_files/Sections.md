...
<sections_test>
  ...
  <test_method duration_seconds='6.005' name='sections_test' timestamp='2017-10-10-Tue-18.03.34.440'>
    <section name='With GithubClient'>
      ...
      <section name='Section with timestamp' timestamp='2017-10-10-Tue-18.03.34.442'>
        <comment>Some test code can go here</comment>
      </section>
      <section duration_seconds='1.000' name='Section with timestamp'>
        <comment>Some test code can go here</comment>
      </section>
      <section duration_seconds='2.001' name='Section with timestamp and duration' timestamp='2017-10-10-Tue-18.03.35.443'>
        <comment>Some test code can go here</comment>
      </section>
      <section duration_seconds='3.001' name='Order does not matter' timestamp='2017-10-10-Tue-18.03.37.444'>
        <comment>Some test code can go here</comment>
      </section>
    </section>
  </test_method>
