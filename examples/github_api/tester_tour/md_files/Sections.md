...
<sections_test>
  ...
  <test_method duration_seconds='6.040' name='sections_test' timestamp='2017-10-14-Sat-12.18.00.157'>
    <section name='With GithubClient'>
      ...
      <section name='Section with timestamp' timestamp='2017-10-14-Sat-12.18.00.157'>
        <comment>Some test code can go here</comment>
      </section>
      <section duration_seconds='1.024' name='Section with timestamp'>
        <comment>Some test code can go here</comment>
      </section>
      <section duration_seconds='2.004' name='Section with timestamp and duration' timestamp='2017-10-14-Sat-12.18.01.181'>
        <comment>Some test code can go here</comment>
      </section>
      <section duration_seconds='3.012' name='Order does not matter' timestamp='2017-10-14-Sat-12.18.03.185'>
        <comment>Some test code can go here</comment>
      </section>
    </section>
  </test_method>
