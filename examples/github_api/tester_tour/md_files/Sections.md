...
<sections_test>
  ...
  <test_method duration_seconds='6.038' name='sections_test' timestamp='2017-11-27-Mon-15.37.11.985'>
    <section name='With GithubClient'>
      ...
      <section name='Section with timestamp' timestamp='2017-11-27-Mon-15.37.11.985'>
        <comment>Some test code can go here</comment>
      </section>
      <section duration_seconds='1.014' name='Section with timestamp'>
        <comment>Some test code can go here</comment>
      </section>
      <section duration_seconds='2.012' name='Section with timestamp and duration' timestamp='2017-11-27-Mon-15.37.12.999'>
        <comment>Some test code can go here</comment>
      </section>
      <section duration_seconds='3.012' name='Order does not matter' timestamp='2017-11-27-Mon-15.37.15.011'>
        <comment>Some test code can go here</comment>
      </section>
    </section>
  </test_method>
