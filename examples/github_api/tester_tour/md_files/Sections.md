...
<sections_test>
  ...
  <test_method duration_seconds='6.032' name='sections_test' timestamp='2017-11-07-Tue-10.46.57.822'>
    <section name='With GithubClient'>
      ...
      <section name='Section with timestamp' timestamp='2017-11-07-Tue-10.46.57.822'>
        <comment>Some test code can go here</comment>
      </section>
      <section duration_seconds='1.016' name='Section with timestamp'>
        <comment>Some test code can go here</comment>
      </section>
      <section duration_seconds='2.000' name='Section with timestamp and duration' timestamp='2017-11-07-Tue-10.46.58.838'>
        <comment>Some test code can go here</comment>
      </section>
      <section duration_seconds='3.016' name='Order does not matter' timestamp='2017-11-07-Tue-10.47.00.838'>
        <comment>Some test code can go here</comment>
      </section>
    </section>
  </test_method>
