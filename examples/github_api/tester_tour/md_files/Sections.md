...
<sections_test>
  ...
  <test_method duration_seconds='6.008' name='sections_test' timestamp='2017-10-24-Tue-11.33.37.383'>
    <section name='With GithubClient'>
      ...
      <section name='Section with timestamp' timestamp='2017-10-24-Tue-11.33.37.385'>
        <comment>Some test code can go here</comment>
      </section>
      <section duration_seconds='1.002' name='Section with timestamp'>
        <comment>Some test code can go here</comment>
      </section>
      <section duration_seconds='2.002' name='Section with timestamp and duration' timestamp='2017-10-24-Tue-11.33.38.388'>
        <comment>Some test code can go here</comment>
      </section>
      <section duration_seconds='3.001' name='Order does not matter' timestamp='2017-10-24-Tue-11.33.40.390'>
        <comment>Some test code can go here</comment>
      </section>
    </section>
  </test_method>
