...
<sections_test>
  ...
  <test_method duration_seconds='6.039' name='sections_test' timestamp='2017-10-23-Mon-10.00.35.405'>
    <section name='With GithubClient'>
      ...
      <section name='Section with timestamp' timestamp='2017-10-23-Mon-10.00.35.405'>
        <comment>Some test code can go here</comment>
      </section>
      <section duration_seconds='1.015' name='Section with timestamp'>
        <comment>Some test code can go here</comment>
      </section>
      <section duration_seconds='2.013' name='Section with timestamp and duration' timestamp='2017-10-23-Mon-10.00.36.420'>
        <comment>Some test code can go here</comment>
      </section>
      <section duration_seconds='3.011' name='Order does not matter' timestamp='2017-10-23-Mon-10.00.38.433'>
        <comment>Some test code can go here</comment>
      </section>
    </section>
  </test_method>
