...
<sections_test>
  ...
  <test_method duration_seconds='6.009' name='sections_test' timestamp='2017-10-11-Wed-15.55.48.257'>
    <section name='With GithubClient'>
      ...
      <section name='Section with timestamp' timestamp='2017-10-11-Wed-15.55.48.259'>
        <comment>Some test code can go here</comment>
      </section>
      <section duration_seconds='1.001' name='Section with timestamp'>
        <comment>Some test code can go here</comment>
      </section>
      <section duration_seconds='2.003' name='Section with timestamp and duration' timestamp='2017-10-11-Wed-15.55.49.261'>
        <comment>Some test code can go here</comment>
      </section>
      <section duration_seconds='3.002' name='Order does not matter' timestamp='2017-10-11-Wed-15.55.51.264'>
        <comment>Some test code can go here</comment>
      </section>
    </section>
  </test_method>
