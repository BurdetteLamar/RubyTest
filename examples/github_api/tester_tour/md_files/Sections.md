...
<sections_test>
  ...
  <test_method duration_seconds='6.032' name='sections_test' timestamp='2017-10-16-Mon-07.36.59.379'>
    <section name='With GithubClient'>
      ...
      <section name='Section with timestamp' timestamp='2017-10-16-Mon-07.36.59.381'>
        <comment>Some test code can go here</comment>
      </section>
      <section duration_seconds='1.004' name='Section with timestamp'>
        <comment>Some test code can go here</comment>
      </section>
      <section duration_seconds='2.015' name='Section with timestamp and duration' timestamp='2017-10-16-Mon-07.37.00.385'>
        <comment>Some test code can go here</comment>
      </section>
      <section duration_seconds='3.011' name='Order does not matter' timestamp='2017-10-16-Mon-07.37.02.400'>
        <comment>Some test code can go here</comment>
      </section>
    </section>
  </test_method>
