...
<sections_test>
  ...
  <test_method duration_seconds='6.047' name='sections_test' timestamp='2017-11-16-Thu-07.27.34.548'>
    <section name='With GithubClient'>
      ...
      <section name='Section with timestamp' timestamp='2017-11-16-Thu-07.27.34.564'>
        <comment>Some test code can go here</comment>
      </section>
      <section duration_seconds='1.016' name='Section with timestamp'>
        <comment>Some test code can go here</comment>
      </section>
      <section duration_seconds='2.016' name='Section with timestamp and duration' timestamp='2017-11-16-Thu-07.27.35.579'>
        <comment>Some test code can go here</comment>
      </section>
      <section duration_seconds='3.000' name='Order does not matter' timestamp='2017-11-16-Thu-07.27.37.595'>
        <comment>Some test code can go here</comment>
      </section>
    </section>
  </test_method>
