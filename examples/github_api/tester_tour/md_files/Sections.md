...
<sections_test>
  ...
  <test_method duration_seconds='6.016' name='sections_test' timestamp='2017-10-29-Sun-05.56.14.753'>
    <section name='With GithubClient'>
      ...
      <section name='Section with timestamp' timestamp='2017-10-29-Sun-05.56.14.753'>
        <comment>Some test code can go here</comment>
      </section>
      <section duration_seconds='1.015' name='Section with timestamp'>
        <comment>Some test code can go here</comment>
      </section>
      <section duration_seconds='2.000' name='Section with timestamp and duration' timestamp='2017-10-29-Sun-05.56.15.768'>
        <comment>Some test code can go here</comment>
      </section>
      <section duration_seconds='3.001' name='Order does not matter' timestamp='2017-10-29-Sun-05.56.17.768'>
        <comment>Some test code can go here</comment>
      </section>
    </section>
  </test_method>
