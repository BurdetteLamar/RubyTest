...
<sections_test>
  ...
  <test_method duration_seconds='6.047' name='sections_test' timestamp='2017-12-03-Sun-10.02.50.833'>
    <section name='With GithubClient'>
      ...
      <section name='Section with timestamp' timestamp='2017-12-03-Sun-10.02.50.833'>
        <comment>Some test code can go here</comment>
      </section>
      <section duration_seconds='1.016' name='Section with timestamp'>
        <comment>Some test code can go here</comment>
      </section>
      <section duration_seconds='2.016' name='Section with timestamp and duration' timestamp='2017-12-03-Sun-10.02.51.849'>
        <comment>Some test code can go here</comment>
      </section>
      <section duration_seconds='3.016' name='Order does not matter' timestamp='2017-12-03-Sun-10.02.53.864'>
        <comment>Some test code can go here</comment>
      </section>
    </section>
  </test_method>
