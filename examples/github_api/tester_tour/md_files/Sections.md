...
<sections_test>
  ...
  <test_method duration_seconds='6.032' name='sections_test' timestamp='2017-11-18-Sat-08.53.47.222'>
    <section name='With GithubClient'>
      ...
      <section name='Section with timestamp' timestamp='2017-11-18-Sat-08.53.47.222'>
        <comment>Some test code can go here</comment>
      </section>
      <section duration_seconds='1.016' name='Section with timestamp'>
        <comment>Some test code can go here</comment>
      </section>
      <section duration_seconds='2.016' name='Section with timestamp and duration' timestamp='2017-11-18-Sat-08.53.48.238'>
        <comment>Some test code can go here</comment>
      </section>
      <section duration_seconds='3.000' name='Order does not matter' timestamp='2017-11-18-Sat-08.53.50.254'>
        <comment>Some test code can go here</comment>
      </section>
    </section>
  </test_method>
