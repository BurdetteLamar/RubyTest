...
<sections_test>
  ...
  <test_method duration_seconds='6.027' name='sections_test' timestamp='2017-10-10-Tue-19.05.15.197'>
    <section name='With GithubClient'>
      ...
      <section name='Section with timestamp' timestamp='2017-10-10-Tue-19.05.15.197'>
        <comment>Some test code can go here</comment>
      </section>
      <section duration_seconds='1.016' name='Section with timestamp'>
        <comment>Some test code can go here</comment>
      </section>
      <section duration_seconds='2.005' name='Section with timestamp and duration' timestamp='2017-10-10-Tue-19.05.16.213'>
        <comment>Some test code can go here</comment>
      </section>
      <section duration_seconds='3.006' name='Order does not matter' timestamp='2017-10-10-Tue-19.05.18.218'>
        <comment>Some test code can go here</comment>
      </section>
    </section>
  </test_method>
