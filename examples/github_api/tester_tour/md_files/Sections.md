...
<sections_test>
  ...
  <test_method duration_seconds='6.016' name='sections_test' timestamp='2017-10-10-Tue-09.37.49.962'>
    <section name='With GithubClient'>
      ...
      <section name='Section with timestamp' timestamp='2017-10-10-Tue-09.37.49.962'>
        <comment>Some test code can go here</comment>
      </section>
      <section duration_seconds='1.012' name='Section with timestamp'>
        <comment>Some test code can go here</comment>
      </section>
      <section duration_seconds='2.001' name='Section with timestamp and duration' timestamp='2017-10-10-Tue-09.37.50.974'>
        <comment>Some test code can go here</comment>
      </section>
      <section duration_seconds='3.003' name='Order does not matter' timestamp='2017-10-10-Tue-09.37.52.975'>
        <comment>Some test code can go here</comment>
      </section>
    </section>
  </test_method>
