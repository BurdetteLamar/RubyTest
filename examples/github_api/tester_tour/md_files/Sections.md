...
<sections_test>
  ...
  <test_method duration_seconds='6.047' name='sections_test' timestamp='2017-12-02-Sat-12.53.40.047'>
    <section name='With GithubClient'>
      ...
      <section name='Section with timestamp' timestamp='2017-12-02-Sat-12.53.40.047'>
        <comment>Some test code can go here</comment>
      </section>
      <section duration_seconds='1.016' name='Section with timestamp'>
        <comment>Some test code can go here</comment>
      </section>
      <section duration_seconds='2.016' name='Section with timestamp and duration' timestamp='2017-12-02-Sat-12.53.41.062'>
        <comment>Some test code can go here</comment>
      </section>
      <section duration_seconds='3.016' name='Order does not matter' timestamp='2017-12-02-Sat-12.53.43.078'>
        <comment>Some test code can go here</comment>
      </section>
    </section>
  </test_method>
