...
<sections_test>
  ...
  <test_method duration_seconds='6.047' name='sections_test' timestamp='2017-11-30-Thu-14.31.35.257'>
    <section name='With GithubClient'>
      ...
      <section name='Section with timestamp' timestamp='2017-11-30-Thu-14.31.35.257'>
        <comment>Some test code can go here</comment>
      </section>
      <section duration_seconds='1.016' name='Section with timestamp'>
        <comment>Some test code can go here</comment>
      </section>
      <section duration_seconds='2.016' name='Section with timestamp and duration' timestamp='2017-11-30-Thu-14.31.36.272'>
        <comment>Some test code can go here</comment>
      </section>
      <section duration_seconds='3.016' name='Order does not matter' timestamp='2017-11-30-Thu-14.31.38.288'>
        <comment>Some test code can go here</comment>
      </section>
    </section>
  </test_method>
