...
<sections_test>
  ...
  <test_method duration_seconds='6.020' name='sections_test' timestamp='2017-11-18-Sat-12.39.52.384'>
    <section name='With GithubClient'>
      ...
      <section name='Section with timestamp' timestamp='2017-11-18-Sat-12.39.52.384'>
        <comment>Some test code can go here</comment>
      </section>
      <section duration_seconds='1.016' name='Section with timestamp'>
        <comment>Some test code can go here</comment>
      </section>
      <section duration_seconds='2.004' name='Section with timestamp and duration' timestamp='2017-11-18-Sat-12.39.53.399'>
        <comment>Some test code can go here</comment>
      </section>
      <section duration_seconds='3.000' name='Order does not matter' timestamp='2017-11-18-Sat-12.39.55.403'>
        <comment>Some test code can go here</comment>
      </section>
    </section>
  </test_method>
