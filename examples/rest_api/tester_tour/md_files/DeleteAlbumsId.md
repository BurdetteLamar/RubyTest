...
<delete_albums_id_test>
  ...
  <test_method name='delete_albums_id_test' timestamp='2017-09-29-Fri-13.25.01.026'>
    <section duration_seconds='2.107' name='With ExampleRestClient'>
      <section name='Test endpoint DELETE albums/id'>
        <section name='Fetch an album to DELETE'>
          <section duration_seconds='0.000' method='GET' name='Rest client' timestamp='2017-09-29-Fri-13.25.01.026' url='https://jsonplaceholder.typicode.com/albums'>
            <parameters/>
          </section>
        ...
        <section name='DELETE the album'>
          <section name='DELETE album' timestamp='2017-09-29-Fri-13.25.02.514'>
            <section duration_seconds='0.000' method='DELETE' name='Rest client' timestamp='2017-09-29-Fri-13.25.02.515' url='https://jsonplaceholder.typicode.com/albums/1'>
              <parameters/>
            </section>
            <section name='Evaluation'>
              ...
              <section duration_seconds='0.000' method='GET' name='Rest client' timestamp='2017-09-29-Fri-13.25.03.053' url='https://jsonplaceholder.typicode.com/albums/1'>
                <parameters/>
              </section>
