...
<delete_albums_id_test>
  ...
  <test_method name='delete_albums_id_test' timestamp='2017-09-27-Wed-15.01.28.058'>
    <section duration_seconds='2.019' name='With ExampleRestClient'>
      <section name='Test endpoint DELETE albums/id'>
        <section name='Fetch an album to DELETE'>
          <section duration_seconds='0.000' method='GET' name='Rest client' timestamp='2017-09-27-Wed-15.01.28.058' url='https://jsonplaceholder.typicode.com/albums'>
            <parameters/>
          </section>
        ...
        <section name='DELETE the album'>
          <section name='DELETE album' timestamp='2017-09-27-Wed-15.01.29.572'>
            <section duration_seconds='0.000' method='DELETE' name='Rest client' timestamp='2017-09-27-Wed-15.01.29.572' url='https://jsonplaceholder.typicode.com/albums/1'>
              <parameters/>
            </section>
            <section name='Evaluation'>
              ...
              <section duration_seconds='0.000' method='GET' name='Rest client' timestamp='2017-09-27-Wed-15.01.29.999' url='https://jsonplaceholder.typicode.com/albums/1'>
                <parameters/>
              </section>
