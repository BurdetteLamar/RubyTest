...
<delete_albums_id_test>
  ...
  <test_method name='delete_albums_id_test' timestamp='2017-09-27-Wed-08.45.41.581'>
    <section duration_seconds='25.638' name='With ExampleRestClient'>
      <section name='Test endpoint DELETE albums/id'>
        <section name='Fetch an album to DELETE'>
          <section duration_seconds='0.000' method='GET' name='Rest client' timestamp='2017-09-27-Wed-08.45.41.585' url='https://jsonplaceholder.typicode.com/albums'>
            <parameters/>
          </section>
        ...
        <section name='DELETE the album'>
          <section name='DELETE album' timestamp='2017-09-27-Wed-08.45.43.081'>
            <section duration_seconds='0.000' method='DELETE' name='Rest client' timestamp='2017-09-27-Wed-08.45.43.082' url='https://jsonplaceholder.typicode.com/albums/1'>
              <parameters/>
            </section>
            <section name='Evaluation'>
              ...
              <section duration_seconds='0.000' method='GET' name='Rest client' timestamp='2017-09-27-Wed-08.46.07.128' url='https://jsonplaceholder.typicode.com/albums/1'>
                <parameters/>
              </section>
