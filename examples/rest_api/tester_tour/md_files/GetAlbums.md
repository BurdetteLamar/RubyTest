...
<get_albums_test>
  ...
  <test_method name='get_albums_test' timestamp='2017-09-29-Fri-13.24.55.484'>
    <section duration_seconds='1.494' name='With ExampleRestClient'>
      <section name='Test endpoint GET albums'>
        <section name='GET albums'>
          <section name='GET albums' timestamp='2017-09-29-Fri-13.24.55.484'>
            <section duration_seconds='0.000' method='GET' name='Rest client' timestamp='2017-09-29-Fri-13.24.55.484' url='https://jsonplaceholder.typicode.com/albums'>
              <parameters/>
            </section>
