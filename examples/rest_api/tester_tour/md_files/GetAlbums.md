...
<get_albums_test>
  ...
  <test_method name='get_albums_test' timestamp='2017-09-25-Mon-18.08.37.519'>
    <section duration_seconds='1.510' name='With ExampleRestClient'>
      <section name='Test endpoint GET albums'>
        <section name='GET albums'>
          <section name='GET albums' timestamp='2017-09-25-Mon-18.08.37.520'>
            <section duration_seconds='0.000' method='GET' name='Rest client' timestamp='2017-09-25-Mon-18.08.37.520' url='https://jsonplaceholder.typicode.com/albums'>
              <parameters/>
            </section>
            <section name='Evaluation'>
              ...
              <verdict id='GET albums - class' message='First object is of class Album' method='verdict_assert_instance_of?' outcome='passed' volatile='false'>
                ...
                <act_value>
                  #&lt;Album:0x401c970 @fields=#&lt;Set: {:id, :userId,
