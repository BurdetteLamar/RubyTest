...
<post_albums_test>
  ...
  <test_method name='post_albums_test' timestamp='2017-09-25-Mon-18.08.48.813'>
    <section duration_seconds='1.854' name='With ExampleRestClient'>
      <section name='Test endpoint POST albums'>
        <section name='Album to post'>
          <section duration_seconds='0.000' method='GET' name='Rest client' timestamp='2017-09-25-Mon-18.08.48.813' url='https://jsonplaceholder.typicode.com/albums'>
            <parameters/>
          </section>
        ...
        <section name='POST the album'>
          <section name='POST album' timestamp='2017-09-25-Mon-18.08.50.343'>
            <section duration_seconds='0.001' method='POST' name='Rest client' timestamp='2017-09-25-Mon-18.08.50.343' url='https://jsonplaceholder.typicode.com/albums'>
            ...
            <section name='Evaluation'>
              ...
              <section duration_seconds='0.000' method='GET' name='Rest client' timestamp='2017-09-25-Mon-18.08.50.515' url='https://jsonplaceholder.typicode.com/albums/1'>
                <parameters/>
              </section>
