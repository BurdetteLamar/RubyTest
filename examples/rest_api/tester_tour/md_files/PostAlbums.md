...
This page shows how to test endpoint POST albums.
...
<post_albums_test>
  ...
  <test_method name='post_albums_test' timestamp='2017-09-24-Sun-16.28.12.574'>
    <section duration_seconds='1.959' name='With ExampleRestClient'>
      <section name='Test endpoint POST albums'>
        <section name='Album to post'>
          <section duration_seconds='0.000' method='GET' name='Rest client' timestamp='2017-09-24-Sun-16.28.12.578' url='https://jsonplaceholder.typicode.com/albums'>
            <parameters/>
          </section>
        ...
        <section name='POST the album'>
          <section name='POST album' timestamp='2017-09-24-Sun-16.28.14.126'>
            <section duration_seconds='0.000' method='POST' name='Rest client' timestamp='2017-09-24-Sun-16.28.14.127' url='https://jsonplaceholder.typicode.com/albums'>
            ...
            <section name='Evaluation'>
              ...
              <section duration_seconds='0.010' method='GET' name='Rest client' timestamp='2017-09-24-Sun-16.28.14.349' url='https://jsonplaceholder.typicode.com/albums/1'>
                <parameters/>
              </section>
