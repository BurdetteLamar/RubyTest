...
<put_albums_id_test>
  ...
  <test_method name='put_albums_id_test' timestamp='2017-09-28-Thu-15.40.04.256'>
    <section duration_seconds='1.883' name='With ExampleRestClient'>
      <section name='Test endpoint PUT albums/id'>
        <section name='Make a modified album'>
          <section duration_seconds='0.000' method='GET' name='Rest client' timestamp='2017-09-28-Thu-15.40.04.257' url='https://jsonplaceholder.typicode.com/albums'>
            <parameters/>
          </section>
        ...
        <section name='PUT the album'>
          <section name='PUT album' timestamp='2017-09-28-Thu-15.40.05.736'>
            <section duration_seconds='0.000' method='PUT' name='Rest client' timestamp='2017-09-28-Thu-15.40.05.736' url='https://jsonplaceholder.typicode.com/albums/1'>
            ...
            <section name='Evaluation'>
              ...
              <section duration_seconds='0.000' method='GET' name='Rest client' timestamp='2017-09-28-Thu-15.40.05.957' url='https://jsonplaceholder.typicode.com/albums/1'>
                <parameters/>
              </section>
