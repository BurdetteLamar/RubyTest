...
<put_albums_id_test>
  ...
  <test_method name='put_albums_id_test' timestamp='2017-09-25-Mon-20.11.50.093'>
    <section duration_seconds='1.968' name='With ExampleRestClient'>
      <section name='Test endpoint PUT albums/id'>
        <section name='Make a modified album'>
          <section duration_seconds='0.000' method='GET' name='Rest client' timestamp='2017-09-25-Mon-20.11.50.095' url='https://jsonplaceholder.typicode.com/albums'>
            <parameters/>
          </section>
        ...
        <section name='PUT the album'>
          <section name='PUT album' timestamp='2017-09-25-Mon-20.11.51.606'>
            <section duration_seconds='0.001' method='PUT' name='Rest client' timestamp='2017-09-25-Mon-20.11.51.607' url='https://jsonplaceholder.typicode.com/albums/1'>
            ...
            <section name='Evaluation'>
              ...
              <section duration_seconds='0.000' method='GET' name='Rest client' timestamp='2017-09-25-Mon-20.11.51.858' url='https://jsonplaceholder.typicode.com/albums/1'>
                <parameters/>
              </section>
