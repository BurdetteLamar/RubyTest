...
class ValuesHelperTest < Minitest::Test
  ...
  def test_string_too_short
    ...
    {
        [(0..1), nil] => nil,
        [(1..1), nil] => ValuesHelper.string_of_length(0),
        [(4..4), nil] => ValuesHelper.string_of_length(3),
        [(0..1), BASE_STRING] => nil,
        [(1..1), BASE_STRING] => '',
  ...
  def test_string_too_long
    ...
    # Good data.
    {
        [(0..0), nil] => ValuesHelper.string_of_length(1),
        [(0..1), nil] => ValuesHelper.string_of_length(2),
        [(0..3), nil] => ValuesHelper.string_of_length(4),
        [(0..0), BASE_STRING] => ValuesHelper.string_of_length(1, BASE_STRING),
        [(0..1), BASE_STRING] => ValuesHelper.string_of_length(2, BASE_STRING),
